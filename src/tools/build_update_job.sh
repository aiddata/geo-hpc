...
python $src/asdf/src/tools/update_trackers.py $branch |& tee -a $output_path

echo -e "\n *** Running update_extract_list.py... \n"  >> '$output_path
python $src/asdf/src/tools/update_extract_list.py $branch |& tee -a $output_path

echo -e "\n *** Running update_msr_list.py... \n" >> '$output_path
python $src/asdf/src/tools/update_msr_list.py $branch |& tee -a $output_path
