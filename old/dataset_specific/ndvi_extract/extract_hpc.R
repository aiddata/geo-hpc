...
out_base <- paste("/sciclone/data20/aiddata/REU/projects/kfw/extracts/ndvi",buffer,"/output/",year,"/",day, sep="")
...
write.table(myOutput, paste(out_base,"/extract",buffer,"_",year,"_",day,".csv", sep=""), quote=T, row.names=F, sep=",")

out_shp <- paste(out_base,"/extract",buffer,"_",year,"_",day,".shp", sep="")
