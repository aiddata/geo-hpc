...
raster = "./data/air_temp_2000_10.tif"
...
stats2 = rs.zonal_stats(vector, raster, stats='mean', weights=False, all_touched=True)#, geojson_out=True)
print stats2
...
stats3 = rs.zonal_stats(vector, raster, stats='mean', weights=True, all_touched=True)#, geojson_out=True)
print stats3
